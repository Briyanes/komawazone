        ...
        <div className="grid grid-cols-2 gap-2.5">
          {tokopedia_url && (
            ...
            >
              ...
              <img src="/icons/tokped.png" alt="Beli di Tokopedia" style={{ height: '56px', width: 'auto', maxWidth: '100%' }} className="shrink-0" />
            </a>
          )}
          {shopee_url && (
            <a
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/icons/shopee.svg" alt="Beli di Shopee" style={{ height: '56px', width: 'auto', maxWidth: '100%' }} className="shrink-0" />
            </a>
          )}
        </div>
      )}
