...
const SOCIALS = [
  ...
  {
    label: 'Discord',
    href: 'https://discord.gg/komawazone',
  ...
  {
    label: 'Facebook',
    href: 'https://facebook.com/komawazone',
    icon: <svg viewBox="0 0 24 24" fill="currentColor" className="size-4"><path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.41c0-3.025 1.792-4.697 4.533-4.697 1.312 0 2.686.236 2.686.236v2.97h-1.513c-1.491 0-1.956.93-1.956 1.883v2.27h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z" /></svg>,
  },
];
  ...
  return (
    <footer className="mt-16" style={{ background: 'var(--bg-primary)', borderTop: '3px solid #FF6B35' }}>
      <div className="mx-auto max-w-7xl px-4 py-10">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <div className="rounded-2xl p-6" style={{ background: 'var(--bg-secondary)', border: '1px solid var(--border-light)' }}>
            <Link href="/" className="mb-4 flex items-center gap-3">
              ...
              <div>
                <div className="text-base font-black leading-none" style={{ color: 'var(--text-primary)' }}>Komawa Zone</div>
                <div className="mt-0.5 text-[10px] font-bold uppercase tracking-[0.2em]" style={{ color: '#FF6B35' }}>Read · Discover · Enjoy</div>
              </div>
            </Link>
            <p className="mb-5 text-xs leading-relaxed" style={{ color: 'var(--text-tertiary)' }}>
              Platform baca manga, manhwa & manhua. Koleksi terlengkap, update harian, gratis selamanya.
            </p>
            {/* Socials */}
            <div>
        ...
        {/* ── Bottom bar ── */}
        <div
          className="mt-8 flex flex-col items-center justify-center gap-1 border-t pt-6 pb-36 md:pb-6 text-center"
