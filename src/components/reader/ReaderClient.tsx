...
export function ReaderClient({
  ...
  return (
    ...
    >
      ...
      {/* WEBTOON MODE */}
      {readMode === 'webtoon' && (
        <div className="flex flex-col items-center pt-20 md:pt-12">
          {/* Auto-advance banner */}
      ...
      {readMode === 'paged' && (
        <div className="flex min-h-dvh flex-col">
          {currentPage > images.length ? (
            ...
            <>
              {/* Image area */}
              <div className="relative flex flex-1 items-center justify-center pt-20 md:pt-12" style={{ minHeight: 'calc(100dvh - 80px)' }}>
                <div
