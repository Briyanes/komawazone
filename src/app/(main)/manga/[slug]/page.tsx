  ...
  return (
    <div className="w-full min-h-screen" style={{ background: 'var(--bg-primary)' }}>
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-5xl px-4 md:px-8 py-8 md:py-12">
      ...
      <div style={{ background: 'var(--bg-secondary)', borderBottom: '1px solid var(--border-light)' }}>
        <div className="mx-auto max-w-5xl px-4 md:px-8 py-3 flex items-center gap-2">
      ...
      {/* ── MAIN CONTENT ─────────────────────────────────────────────── */}
      <div className="mx-auto max-w-5xl px-4 md:px-8 py-5">
